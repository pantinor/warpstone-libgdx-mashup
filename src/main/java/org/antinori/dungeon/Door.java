...
public class Door {
    ...
    /**
     * Replace one of the rooms connected by this door with another. Used when
     * merging rooms and transitioning doors
     *
     * @param original The original room that has been merged out
     * @param replacement The room that has taken it's place
     */
    public void replace(DungeonMapGenerator map, Room original, Room replacement) {
        if (roomA == original) {
    ...
    public void validate(DungeonMapGenerator map) {
